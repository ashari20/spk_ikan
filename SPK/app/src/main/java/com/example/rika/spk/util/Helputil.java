...
public class Helputil {
    ...
    public static final String IMAGE_DIR_NAME = "spk_image";
    ...
    public static String Club_ToUpperCase(String origin){
        if (origin.length() > 5) {
            ...
            if (textsplit[0].contains("tk") || textsplit[0].contains("sd") || textsplit[0].contains("sm")){
                output = textsplit[0].toUpperCase() + " ";
            }
